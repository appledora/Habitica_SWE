...
import com.tgc.appledora.habitica.sleepCycle.tabs.adapters.ActiveAlarmsAdapter;
import com.tgc.appledora.habitica.sleepCycle.tabs.ui.EmptyStateRecyclerView;
import com.tgc.appledora.habitica.sleepCycle.tabs.ui.dialog.ItemDialogContract;
...
public class AlarmsFragment extends Fragment
    ...
    public void showEditAlarmDialog(final Alarm alarm) {
        ...
        builder.setView(content)
                ...
                .setNegativeButton(negativeButtonText, (dialogInterface, i) -> dialog.dismiss());
        content.findViewById(R.id.i_dialog_item_ringtone)
                .setOnClickListener(view -> startRingtonePickerActivityForResult());
